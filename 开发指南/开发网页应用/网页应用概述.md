...
src= "https://lf-scm-cn.feishucdn.com/lark/op/h5-js-sdk-1.5.48.js"
></script>
```warning
- 在升级功能时，JS 文件的版本会作相应更新。上方代码中已经是最新的 JSSDK 版本对应的 src。JSSDK 版本号格式为`Major.Minor.Patch`（主版本号.次版本号.修订版本号），例如`https://lf-scm-cn.feishucdn.com/lark/op/h5-js-sdk-1.5.48.js`中的 JSSDK 版本号为`1.5.48`。
